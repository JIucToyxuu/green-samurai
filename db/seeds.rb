...
course_list = [
	...
	[ "Мастер класс от ведущих оленеводов(как слить бой)", '1', 'code2', '14/01/2014', '3 дня', '18', 'На Слииииив!', 'Старайтесь не уничтожать врага, так ваши шансы на слив значительно возрастают', '', 25, 'cours_img_02.jpg', true ],
	[ "КВ-5 - тяжелый танк", '2', 'code3', '14/02/2015', '3 дня', '18', 'Гайд по тяжелому танку СССР КВ-5(как тащить)', 'Уберите от экранов радистов и всех со слабыми нервами', '', 25, 'cours_img_03.jpg', false ],
	[ "Как пробить тяжей", '4', 'code4', '14/02/2014', '2 дня', '11', 'Безысходность', 'Для пробития многих бронемашин вам помогут премиум-снаряды! Заряжай "голду"!', '', 25, 'cours_img_04.jpg', true ]
]
