...
course_list = [
	...
	[ "Мастер класс от ведущих оленеводов", '1', 'code2', '14/01/2014', '3 дня', '18', 'На Слииииив!', 'Старайтесь не уничтожать врага, так ваши шансы на слив значительно возрастают', '', 25, 'cours_img_02.jpg', true ],
